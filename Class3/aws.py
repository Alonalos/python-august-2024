...
INSTANCE_IDS = ['i-0957f8876d8ec69b3', 'i-07629ac0eafbfb05e']  # Replace with your actual EC2 instance IDs
...
schedule.every().day.at("21:58").do(start_instances)  # Schedules start at 8:00 AM
schedule.every().day.at("21:59").do(stop_instances)   # Schedules stop at 6:00 PM
